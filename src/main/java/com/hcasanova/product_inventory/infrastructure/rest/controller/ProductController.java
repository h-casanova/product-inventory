...
public class ProductController {
  ...
  @Operation(
      ...
      description = "Returns all products. Supports optional pagination, filtering and sorting.")
  public List<ProductDTO> getAll(
      @QueryParam("page") @Min(value = 0, message = "Page must be >= 0") @DefaultValue("0")
          int page,
      @QueryParam("size") @Min(value = 0, message = "Size must be >= 0") @DefaultValue("0")
          int size,
  ...
  @Operation(
      ...
      description = "Creates a new product from given data.")
  ...
  @Operation(
      ...
      description = "Creates multiple products from the provided list.")
  public List<ProductDTO> createBulkProducts(List<@Valid ProductDTO> requests) {
    return productMapper.toDTOList(
        productService.createBulkProducts(requests.stream().map(productMapper::toEntity).toList()));
  }
  ...
  @Operation(
      ...
      description = "Updates an existing product. Version must be provided.")
